...
$(document).ready(function() { 	
	...
	//------------- Masked input fields -------------//
	// $("#number_cc").mask("(999) 999-9999", {completed:function(){alert("Callback action after complete");}});
	// $("#mask-phoneExt").mask("(999) 999-9999? x99999");
	$("#number_cc").mask("0000 0000 0000 0000");
	$("#cvv").mask("000");
	$("#validate_cc").mask("00/00/0000", {clearIfNotMatch: true});
